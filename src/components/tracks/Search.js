                    ...
                    return (
                        <div className="card card-body mb-4 p-4">
                            ...
                            <form onSubmit={this.findTrack.bind(this, dispatch)}>
                                <div>
                                    <input type="text" className="form-control form-contol-lg" placeholder="Song title..." name="trackTitle" 
                                    value={this.state.trackTitle}
                                    onChange={this.onChange}
                                    />
                                </div>
                                <br/>
                                <button className="btn btn-primary btn-lg btn-block mb-5" type="submit">Get Track</button>
                            </form>
                        </div>
                    )
                }}
